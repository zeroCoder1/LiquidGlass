...
void main() {
  ...
  function resolveBackground(bg) {
    return __async(this, null, function* () {
      if (typeof bg === "string") {
        ...
        } else yield new Promise((res, rej) => {
          img.onload = res;
          img.onerror = rej;
        });
        return img;
  ...
  var LiquidGlass = class {
    ...
    setBackground(bg) {
      return __async(this, null, function* () {
        this._bg = yield resolveBackground(bg);
        if (this._destroyed) return;
    ...
    get(key) {
      return key ? this.params[key] : __spreadValues({}, this.params);
    }
    setPosition(x, y) {
      this._x = x;
      this._y = y;
  ...
  function glassify(target, opts = {}) {
    return resolveTargets(target).map((el) => new LiquidGlass(__spreadProps(__spreadValues({}, opts), { adopt: el })));
  }
  ...
  var toKebab = (s) => s.replace(/[A-Z]/g, (m) => "-" + m.toLowerCase());
  var PARAM_ATTRS = Object.fromEntries(Object.keys(PARAM_DEFS).map((k) => [toKebab(k), k]));
  var LiquidGlassElement = class extends HTMLElement {
    ...
    connectedCallback() {
      ...
      const opts = __spreadValues({ stage }, this._readParams());
    ...
    disconnectedCallback() {
      var _a;
      (_a = this._glass) == null ? void 0 : _a.destroy();
      this._glass = null;
    }
  ...
  function defineLiquidGlass(tag = "liquid-glass") {
  ...
  // src/global.js
  liquid_glass_default.glassify = glassify;
  liquid_glass_default.detectDomCapabilities = detectDomCapabilities;
  liquid_glass_default.defineLiquidGlass = defineLiquidGlass;
  liquid_glass_default.LiquidGlassElement = LiquidGlassElement;
  liquid_glass_default.DEFAULTS = DEFAULTS;
  liquid_glass_default.PARAM_DEFS = PARAM_DEFS;
  var _global = typeof globalThis !== "undefined" ? globalThis : typeof window !== "undefined" ? window : typeof self !== "undefined" ? self : null;
  if (_global) _global.LiquidGlass = liquid_glass_default;
  var global_default = liquid_glass_default;
})();
//# sourceMappingURL=liquid-glass.global.js.map
